...
/*
Date: Saturday 31st December 2022, 11:37 PT
Programmer: Anne Dawson
Email: anne.dawson@gmail.com
App: Compose for Wear OS Code Lab
File: MainActivity.kt
Purpose: To demonstrate how to use composables for Wear OS on Fossil Carlyle Smartwatch
From:  https://developer.android.com/codelabs/compose-for-wear-os#0
Status: Completed
 */
...
fun WearApp() {
    WearAppTheme {
        ...
        Scaffold(
            ...
            vignette = {
                // Only show a Vignette for scrollable screens.
                // This code lab only has one screen,
